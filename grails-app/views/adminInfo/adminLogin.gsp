...
<html lang="ch">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${resource(dir: 'css',file: 'flat-ui.min.css')}" />
	...
	<body>
       ...
       <div class="logo">
        	...
        	<h5 style="width:100%; text-align:center;">KBVS知识库管理系统后台登录</h5>
            <div class="login-box">
		<div class="box-con tran">
			<div class="login-con f-l">
			 <g:form controller="adminInfo" action="doAdminLogin" method="post">
				<div class="form-group">
					<input type="text" placeholder="登录名" name="name" id="loginName" onblur="verify.verifyLoginName(this)"/>
					<span class="error-notic">登录名不能为空</span>
				</div>
				<div class="form-group"> 
					<input type="password" placeholder="密码" name="password" id="password" onblur="verify.verifyPassword(this)">
