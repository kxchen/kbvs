        ...
        <div class="left-bar">
            <div class="nav-left">
                <ul class="list-unstyled nav-left-ul">
                    ...
                    <g:link action="categoryPage" id="word" style="text-decoration: none"><li class="current"><i class="fa fa-file-text-o"></i><span class="text">文档</span></li></g:link>
                    ...
                    <div class="header" style="border:none;">
                        <g:form controller="resourceInfo" action="categorySearch" method="get" class="navbar-form navbar-right hidden-xs sea" role="search">
                            <div class="form-group">
                                <input type="text" class="form-control search" placeholder="搜索文本" name="search"  value="${search}">
                    ...
                    <div class="body">
                        ...
                        <div class="body-nav">
                            ...
                            <div class="textscrollbar">
                                %{--触发滚动事件的条件--}%
                                <div class="textfilescrollbar">

                                    <div class="row text_pagerow " id="wjs">
                                        <g:each in="${ResourceInfoList}" status="i" var="resourceInfoInstance">
                                         <div class="${resourceInfoInstance.id}">
                                        <div class="col-lg-2 col-md-3 textgroup" >
                                            <div class="thumbnail textlol" >
                                                <input type="checkbox" class="textpage_checkbox" name="checkAll" value="${resourceInfoInstance.id}" onClick="setSelectAll()">
                                            <g:link action="show" id="${resourceInfoInstance.id}">
                                                <label class="textmingcheng"> ${raw(resourceInfoInstance.name)}</label>
                                                <img src="${resource(dir: '',file: resourceInfoInstance.preImgPath)}" class="special_img">
                                            </g:link>
                                            </div>
                                            <div class="caption text_bl">
                                                <div class="text_bl_limian">
                                                    <p class="textzaiyao">${raw(resourceInfoInstance.remark)}</p>
                                                    <p class="btn-right">
                    ...
                    success:function(msg){
                        ...
                        for(var i= 0;i<ResourceInfoList.length;i++){
                            ...
                            var res='<div class="'+resourceInfo.id+'">' +
                                    '<div class="col-lg-2 col-md-3 textgroup" ><div class="thumbnail textlol" >' +
                                    '<input type="checkbox" class="textpage_checkbox" name="checkAll" value="'+resourceInfo.id+'" onClick="setSelectAll()">' +
                                    '<a href="/kbvs/resourceInfo/show/'+resourceInfo.id+'">' +
                                    '<label class="textmingcheng">'+resourceInfo.name+'</label>' +
                                    '<img src="'+path+resourceInfo.preImgPath+'" class="special_img"></a></div>' +
                                    '<div class="caption text_bl"><div class="text_bl_limian">' +
                                    '<p class="textzaiyao">'+resourceInfo.remark+'</p><p class="btn-right">' +
