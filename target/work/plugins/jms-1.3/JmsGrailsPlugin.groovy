...
class JmsGrailsPlugin {
    ...
    def description = """\
This plugin makes it easy to integrate your Grails applications with \
JMS message brokers. Send messages simply and easily through @send@ methods \
that are available from any artifact. And register services as listeners. It \
supports both queues and topics, as well as selectors."""

    def license = "APACHE"
    def scm = [url: "https://github.com/gpc/grails-jms"]
    def issueManagement = [system: "JIRA", url: "http://jira.grails.org/browse/GPJMS"]
    def documentation = "http://gpc.github.io/grails-jms/"
